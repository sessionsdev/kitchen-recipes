<body class="bg-gradient-to-b from-gray-200 to-gray-400 bg-fixed h-full">

    <!-- main container -->
    <div class="container mx-auto p-4">

      <h1 class="text-center text-4xl">Tailwind CSS -  Recipe Cards</h1>
      <p class="text-center text-gray-800 mb-8">
        Built by <a class="underline hover:no-underline" href="http://www.scottturner.co.uk" target="_blank">Scott Turner</a>
      </p>
